...
<p>
However, I my system adopted \ahref{https://peps.python.org/pep-0668/}{PEP 668}. I realized that it is already available in the repository. It can be installed by: sudo apt install jupyter-notebook
</p>
<h2> Note: </h2>
<p>
